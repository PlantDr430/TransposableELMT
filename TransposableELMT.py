...
parser.add_argument(
    '-rb',
    '--repbase_lib',
    help = 'RepBase library of TEs or additional curated library',
    metavar=''
)
parser.add_argument(
    '-rl',
...
parser.add_argument(
    ...
    help = 'Path to directory containing TE .hmm pfam domain files in HMMER3 format [Default: LTR_wrap/te_hmms]',
    metavar=''
)
parser.add_argument(
    '--REPEATMODELER_PATH',
